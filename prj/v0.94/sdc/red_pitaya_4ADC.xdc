...
#set_false_path -from [get_clocks clk_fpga_0] -to [get_pins {sys_bus_interconnect/inst_sys_bus_cdc/bus_m\\.addr*[*]*/D}]
#set_false_path -from [get_clocks clk_fpga_0] -to [get_pins {sys_bus_interconnect/inst_sys_bus_cdc/bus_m\\.wdata*[*]*/D}]


set_false_path -from [get_clocks clk_fpga_0] -to [get_pins {sys_bus_interconnect/inst_sys_bus_cdc/reg_do_csff*/D}]
set_false_path -from [get_clocks clk_fpga_0] -to [get_pins {sys_bus_interconnect/inst_sys_bus_cdc/reg_do_write_csff*/D}]
set_false_path -from [get_clocks clk_fpga_0] -to [get_pins {sys_bus_interconnect/inst_sys_bus_cdc/reg_do_read_csff*/D}]
set_false_path -from [get_clocks pll_adc_clk] -to [get_pins {sys_bus_interconnect/inst_sys_bus_cdc/ctrl_done_csff*/D}]
set_false_path -from [get_clocks pll_adc_clk] -to [get_pins {sys_bus_interconnect/inst_sys_bus_cdc/ctrl_done_csff*/D}]
