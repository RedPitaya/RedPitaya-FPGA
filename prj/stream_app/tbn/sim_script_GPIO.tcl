...
delete_bd_objs [get_bd_intf_nets axi_interconnect_2_M00_AXI]
...
delete_bd_objs [get_bd_addr_segs processing_system7_0/Data/SEG_rp_gpio_reg0]
...
connect_bd_intf_net [get_bd_intf_ports M_AXI_OSC] [get_bd_intf_pins axi_interconnect_2/M00_AXI]
...
assign_bd_address -target_address_space /rp_gpio/axi_gpio_in [get_bd_addr_segs M_AXI_OSC/Reg] -force
set_property offset 0x00000000 [get_bd_addr_segs {rp_gpio/axi_gpio_in/SEG_M_AXI_OSC_Reg}]
set_property range 512M [get_bd_addr_segs {rp_gpio/axi_gpio_in/SEG_M_AXI_OSC_Reg}]

assign_bd_address -target_address_space /rp_gpio/axi_gpio_out [get_bd_addr_segs M_AXI_OSC/Reg] -force
set_property offset 0x00000000 [get_bd_addr_segs {rp_gpio/axi_gpio_out/SEG_M_AXI_OSC_Reg}]
set_property range 512M [get_bd_addr_segs {rp_gpio/axi_gpio_out/SEG_M_AXI_OSC_Reg}]
