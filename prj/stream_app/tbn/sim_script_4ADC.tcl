...
delete_bd_objs [get_bd_intf_nets axi_interconnect_3_M00_AXI]
delete_bd_objs [get_bd_intf_nets processing_system7_0_M_AXI_GP0]
delete_bd_objs [get_bd_addr_segs processing_system7_0/Data/SEG_rp_oscilloscope0_reg0]
delete_bd_objs [get_bd_addr_segs processing_system7_0/Data/SEG_rp_oscilloscope1_reg0]
delete_bd_objs [get_bd_nets processing_system7_0_FCLK_RESET0_N]



create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M_AXI_OSC0
create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M_AXI_OSC1
...
set_property -dict [list CONFIG.HAS_QOS {1} CONFIG.HAS_REGION {0} CONFIG.NUM_WRITE_OUTSTANDING {8} CONFIG.NUM_READ_OUTSTANDING {8} CONFIG.FREQ_HZ {125000000} CONFIG.PROTOCOL {AXI3} CONFIG.DATA_WIDTH {64}] [get_bd_intf_ports M_AXI_OSC0]
set_property -dict [list CONFIG.HAS_QOS {1} CONFIG.HAS_REGION {0} CONFIG.NUM_WRITE_OUTSTANDING {8} CONFIG.NUM_READ_OUTSTANDING {8} CONFIG.FREQ_HZ {125000000} CONFIG.PROTOCOL {AXI3} CONFIG.DATA_WIDTH {64}] [get_bd_intf_ports M_AXI_OSC1]

connect_bd_intf_net [get_bd_intf_ports S_AXI_REG] -boundary_type upper [get_bd_intf_pins axi_reg/S00_AXI]
#connect_bd_intf_net [get_bd_intf_ports S_AXI_REG] [get_bd_intf_pins axi_register_slice_0/S_AXI]

connect_bd_intf_net [get_bd_intf_ports M_AXI_OSC0] [get_bd_intf_pins axi_interconnect_0/M00_AXI]
connect_bd_intf_net [get_bd_intf_ports M_AXI_OSC1] [get_bd_intf_pins axi_interconnect_3/M00_AXI]

set_property -dict [list CONFIG.CLK_DOMAIN {/clk_gen0_clk_out1}] [get_bd_intf_ports M_AXI_OSC0]
set_property -dict [list CONFIG.CLK_DOMAIN {/clk_gen0_clk_out1}] [get_bd_intf_ports M_AXI_OSC1]
set_property CONFIG.ASSOCIATED_BUSIF {S_AXI_REG:HK_AXI} [get_bd_ports /FCLK_CLK2]
set_property CONFIG.ASSOCIATED_BUSIF {M_AXI_OSC0:M_AXI_OSC1} [get_bd_ports /clk_out125_0]
...
assign_bd_address -target_address_space /S_AXI_REG [get_bd_addr_segs rp_gpio/s_axi_reg/reg0] -force
...
assign_bd_address -target_address_space /rp_oscilloscope/m_axi_osc1 [get_bd_addr_segs M_AXI_OSC0/Reg] -force
set_property offset 0x00000000 [get_bd_addr_segs {rp_oscilloscope/m_axi_osc1/SEG_M_AXI_OSC0_Reg}]
set_property range 512M [get_bd_addr_segs {rp_oscilloscope/m_axi_osc1/SEG_M_AXI_OSC0_Reg}]

assign_bd_address -target_address_space /rp_oscilloscope/m_axi_osc2 [get_bd_addr_segs M_AXI_OSC0/Reg] -force
set_property offset 0x00000000 [get_bd_addr_segs {rp_oscilloscope/m_axi_osc2/SEG_M_AXI_OSC0_Reg}]
set_property range 512M [get_bd_addr_segs {rp_oscilloscope/m_axi_osc2/SEG_M_AXI_OSC0_Reg}]

assign_bd_address -target_address_space /rp_oscilloscope/m_axi_osc3 [get_bd_addr_segs M_AXI_OSC1/Reg] -force
set_property offset 0x00000000 [get_bd_addr_segs {rp_oscilloscope/m_axi_osc3/SEG_M_AXI_OSC1_Reg}]
set_property range 512M [get_bd_addr_segs {rp_oscilloscope/m_axi_osc3/SEG_M_AXI_OSC1_Reg}]

assign_bd_address -target_address_space /rp_oscilloscope/m_axi_osc4 [get_bd_addr_segs M_AXI_OSC1/Reg] -force
set_property offset 0x00000000 [get_bd_addr_segs {rp_oscilloscope/m_axi_osc4/SEG_M_AXI_OSC1_Reg}]
set_property range 512M [get_bd_addr_segs {rp_oscilloscope/m_axi_osc4/SEG_M_AXI_OSC1_Reg}]

assign_bd_address -target_address_space /rp_gpio/axi_gpio_in [get_bd_addr_segs S_AXI_HP1/Reg] -force
set_property offset 0x00000000 [get_bd_addr_segs {rp_gpio/axi_gpio_in/SEG_processing_system7_0_HP1_DDR_LOWOCM}]
set_property range 512M [get_bd_addr_segs {rp_gpio/axi_gpio_in/SEG_processing_system7_0_HP1_DDR_LOWOCM}]

assign_bd_address -target_address_space /rp_gpio/axi_gpio_out [get_bd_addr_segs S_AXI_HP1/Reg] -force
set_property offset 0x00000000 [get_bd_addr_segs {rp_gpio/axi_gpio_out/SEG_processing_system7_0_HP1_DDR_LOWOCM}]
set_property range 512M [get_bd_addr_segs {rp_gpio/axi_gpio_out/SEG_processing_system7_0_HP1_DDR_LOWOCM}]

assign_bd_address -target_address_space /S_AXI_REG [get_bd_addr_segs HK_AXI/Reg] -force
set_property range 1M [get_bd_addr_segs {S_AXI_REG/SEG_HK_AXI_Reg}]
set_property offset 0x40300000 [get_bd_addr_segs {S_AXI_REG/SEG_HK_AXI_Reg}]

delete_bd_objs [get_bd_nets processing_system7_0_FCLK_RESET2_N]
connect_bd_net [get_bd_ports FCLK_RESET2_N] [get_bd_pins processing_system7_0/FCLK_RESET2_N]
...
connect_bd_net [get_bd_ports rst_in] [get_bd_pins rst_gen3/ext_reset_in]
...
add_files -fileset sim_1 -norecurse {../../tbn/clk_gen.v}
...
set_property used_in_simulation false [get_files red_pitaya_top_4ADC.sv]
set_property top top_tb_4ADC [get_filesets sim_1]
