...
set_clock_groups -logically_exclusive -group [get_clocks -include_generated_clocks adc_clk_01] -group [get_clocks -include_generated_clocks daisy_clk]
set_clock_groups -logically_exclusive -group [get_clocks -include_generated_clocks adc_clk_23] -group [get_clocks -include_generated_clocks daisy_clk]

set_false_path -from [get_clocks adc_clk_01] -to [get_clocks {adc_clk_23 clk_fpga_2}]
set_false_path -from [get_clocks adc_clk_23] -to [get_clocks {adc_clk_01 clk_fpga_2}]
set_false_path -from [get_clocks clk_fpga_2] -to [get_clocks {adc_clk_01 adc_clk_23}]

set_false_path -from [get_clocks clk_125_system_clk_gen0_0] -to [get_clocks {daisy_clk clk_fpga_2}]
set_false_path -from [get_clocks clk_200_system_clk_gen0_0] -to [get_clocks {daisy_clk clk_fpga_2}]
set_false_path -from [get_clocks daisy_clk] -to [get_clocks {clk_125_system_clk_gen0_0 clk_200_system_clk_gen0_0 clk_fpga_2}]
set_false_path -from [get_clocks clk_fpga_2] -to [get_clocks {clk_125_system_clk_gen0_0 clk_200_system_clk_gen0_0 daisy_clk}]