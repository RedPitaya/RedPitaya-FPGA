...
begin
  ...
  adc_data_ch3_signed <= {adc_data_ch3[ADC_DATA_BITS-1], ~{adc_data_ch3[ADC_DATA_BITS-2:0],{(16-ADC_DATA_BITS){adc_sign_ch3}}}}; 
  adc_data_ch4_signed <= {adc_data_ch4[ADC_DATA_BITS-1], ~{adc_data_ch4[ADC_DATA_BITS-2:0],{(16-ADC_DATA_BITS){adc_sign_ch4}}}}; 
end
...
assign s_axis_osc3_tdata = adc_data_ch3_signed;
assign s_axis_osc4_tdata = adc_data_ch4_signed;
